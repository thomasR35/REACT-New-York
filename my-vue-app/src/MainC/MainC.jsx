    ...
    <main>
      ...
      <section>
        ...
        <article className="clear">
          ...
          />
          <p>
            Située sur la <strong>Liberty Island</strong>, au sud de Manhattan à
            l'embouchure de l'Hudson et à proximité d'Ellis Island. Son
            véritable nom est <em>Liberty Enlightening the World</em>, en
            français La Liberté éclairant le monde, mais est plus connue sous le
            nom de statue de la Liberté (Statue of Liberty).
          </p>
          <p>
      ...
      <section className="clear">
        ...
        <p>
          ...
          <strong>Liberty Island</strong> et
          <strong>Ellis Island</strong> sont de petites îles au sud de Manhattan
          dont les lieux historiques sont visités par les touristes.
          <strong>Staten Island</strong> est l'île la plus au sud de New York.
          Les arrondissements de <em>Brooklyn</em> et <em>Queens</em> occupent
          la partie occidentale de Long Island alors que le <em>Bronx</em> se
          trouve sur le continent, dans le Sud d'une presqu'île.
        </p>
        <p>
          ...
          facilement. Plusieurs détroits comme le
          <em>Long Island Sound</em> ou <em>The Narrows</em> séparent les
          différentes îles. Les eaux profondes de la baie de New York et les
          côtes très découpées fournissent de nombreuses autres petites baies
          abritées. Le site de New York apparaît à la fois comme un atout
          (ouverture maritime, défense naturelle) mais aussi comme un risque
          (inondations, élévation de la mer, raz-de-marée) pour la métropole.
        </p>
      </section>
      <section className="clear">
        <h2 id="demographie">Démographie</h2>
        <img
          src="img/taxi-cab.jpg"
          alt="Rue de New York avec taxis"
          className="gauche"
        />
        <p>
